...
def test_umu_actions_keep_library_details_visible():
    ...
    entry = SimpleNamespace(
        ...
        _LibraryEntry__umu_actions_popover=SimpleNamespace(get_visible=lambda: False),
    ...
    entry._LibraryEntry__umu_actions_popover = SimpleNamespace(get_visible=lambda: True)
